        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('/dashboard/informes')}}" data-bs-toggle="collapse" href="#horizontal-menu" role="button"
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('/dashboard/comparacion')}}" data-bs-toggle="collapse" href="#horizontal-menu" role="button"
                            aria-expanded="false" aria-controls="horizontal-menu">
                            <i class="icon">
                            ...
                            <span class="item-name">Comparacion</span>
                        </a>
                      
                    </li>
                   
                         <li class="nav-item">
                        <a class="nav-link" href="{{url('/dashboard/seguimiento')}}" data-bs-toggle="collapse" href="#horizontal-menu" role="button"
                            aria-expanded="false" aria-controls="horizontal-menu">
                            <i class="icon">
                        ...
                        <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    ...
                                    <li><a class="dropdown-item" href="../dashboard/auth/sign-in.html">Cerrar sesión</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
