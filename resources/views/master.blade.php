...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css"
        integrity="sha512-DTOQO9RWCH3ppGqcWaEA1BIZOC6xxalwEsw9c2QQeAIftl+Vegovlnee1c9QX4r0L8n2R9E6MZ7zj2z4h0Q=="
...
<body class="  ">
            ...
            <a href="{{ url('/dashboard/home') }}" class="navbar-brand">
                ...
                <div class="logo-main">
                    <div class="logo-normal">
                        <img src="{{ asset('public/img/logo.png') }}" alt="Logo ACAMA"
        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="{{ url('/dashboard/home') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/dashboard/informes') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/dashboard/comparacion') }}">
                            <i class="fas fa-balance-scale me-2"></i>
                            <span class="item-name">Comparación</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/dashboard/seguimiento') }}">
                            <i class="fas fa-route me-2"></i>
                            <span class="item-name">Seguimiento</span>
                        </a>
                    </li>
    ...
    <main class="main-content">
                        ...
                        <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown"
                                    ...
                                    <img src="{{ asset('public/img/perfil.png') }}" alt="User-Profile"
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    {{-- <li><a class="dropdown-item" href="../dashboard/app/user-profile.html">Perfil</a>
                                    </li> --}}
        ...
        <div class="conatiner-fluid content-inner mt-n5 py-0">
            ...
            <button id="btnNuevoServicio"
                class="btn btn-primary shadow-lg rounded-circle d-flex align-items-center justify-content-center"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title fw-bold">
                                <i class="ti ti-clipboard-list me-2"></i> Solicitar servicio
                            </h5>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="servicio" required>
                                        ...
                                        <option value="Agua">Análisis de Agua</option>
                                        <option value="Alimentos">Análisis de Alimentos</option>
    ...
    <script>
        ...
        document.getElementById('formNuevoServicio').addEventListener('submit', function(e) {
            ...
            // aquí puedes hacer fetch / axios a Laravel
