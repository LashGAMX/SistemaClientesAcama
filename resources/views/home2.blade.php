                ...
                <li class="nav-item dropdown">
                  <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <div class="caption ms-3 d-none d-md-block ">
                        <h6 class="mb-0 caption-title">Luis Santiago</h6>
                        <p class="mb-0 caption-sub-title">Clientes</p>
                    </div>
                  </a>
                  ...
                  <div class="card-body">
                     <div class="progress-widget">
                        ...
                        <div class="progress-detail">
                           <p  class="mb-2">Completos</p>
                           <h4 class="counter">100 / 110</h4>
                        </div>
                     </div>
                  </div>
               </li>
      ...
      <div class="row">
         <div class="col-md-12">
            <div class="card" data-aos="fade-up" data-aos-delay="800">
               <div class="flex-wrap card-header d-flex justify-content-between align-items-center">
                  <div class="header-title">
                     <h4 class="card-title">Progeso ultima orden</h4>
         ...
         <div class="col-md-12 col-xl-6">
            <div class="card" data-aos="fade-up" data-aos-delay="900">
               <div class="flex-wrap card-header d-flex justify-content-between">
                  <div class="header-title">
                     <h4 class="card-title">% de Satisfaccion </h4>            
                  </div>   
                  <div class="dropdown">
                  ...
                  <div class="flex-wrap d-flex align-items-center justify-content-between">
                     ...
                     <div class="d-grid gap col-md-4 col-lg-4">
                        <div class="d-flex align-items-start">
                           ...
                           <div class="ms-3">
                              <span class="text-gray">Folio</span>
                              <h6>100%</h6>
                           </div>
                        </div>
                        <div class="d-flex align-items-start">
                           ...
                           <div class="ms-3">
                              <span class="text-gray">Folio2</span>
                              <h6>90%</h6>
                           </div>
                        </div>
                     </div>
         ...
         <div class="col-md-12 col-xl-6">
            <div class="card" data-aos="fade-up" data-aos-delay="1000">
               <div class="flex-wrap card-header d-flex justify-content-between">
                  <div class="header-title">
                     <h4 class="card-title">Ultimos folios</h4>            
                  </div>
                  <div class="dropdown">
                              ...
                              <td>
                                 <div class="iq-media-group iq-media-group-1">
                                    <a href="#" class="iq-media-1">
                                       <div class="icon iq-icon-box-3 rounded-pill">365-25/25</div>
                                    </a>
                                 </div>
                              </td>
                              <td>NOM-SEMARNAT-001-2021</td>
                              <td>
                            ...
                            <tr>
                             ...
                             <tr>
                              ...
                              <td>
                                 ...
                                 <div class="shadow-none progress bg-soft-primary w-100" style="height: 4px">
                                    <div class="progress-bar bg-primary" data-toggle="progress-bar" role="progressbar" aria-valuenow="900" aria-valuemin="0" aria-valuemax="100"></div>
                                 </div>
                              </td>
                           </tr>
                             <tr>
         ...
         <div class="col-md-12 col-lg-12">
            <div class="card credit-card-widget" data-aos="fade-up" data-aos-delay="900">
              ...
              <div class="card overflow-hidden">
                <div class="card-header d-flex justify-content-between flex-wrap">
                    <div class="header-title">
                        <h4 class="card-title mb-2">Promocione del mes</h4>
                       
                    </div>
                </div>
                <div class="card-body p-2">
                    <div class="table-responsive mt-4">
                       <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSeGU7ok1Sf87vBvPAWstBsLDndgfsZQIcJSA&s" alt="" class="img-fluid" style="width: 100%;">
                </div>
            </div>
               </div>
            </div>
